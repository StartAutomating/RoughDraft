...
|AudioGain|Increases audio volume|editor,edit,Show-Media,Edit-Media|
|BlackDetect|Detect black periods in a video.|Get-Media|
|BlackFrame|Detects black frames.|Get-Media|
|BlendFrame|BlendFrame Extension|editor,edit,Show-Media,Edit-Media|
...
|Echo|Adds echoes to audio|editor,edit,Show-Media,Edit-Media|
|EdgeDetect|EdgeDetect Extension|Edit-Media,Show-Media|
|Emboss|Embosses video or images|Edit-Media|
|Exposure|Exposure Extension|editor,edit,Show-Media,Edit-Media|
...
|Hue|Hue Extension|editor,edit,Show-Media,Edit-Media|
|LagFun|Slowly update darker pixels.|editor,edit,Show-Media,Edit-Media|
...
|MedianPixel|Picks median pixels|editor,edit,Show-Media,Edit-Media|
...
|RandomizeFrame|RandomizeFrame extensions|editor,edit,Show-Media,Edit-Media|
