...
|AudioGain|Increases audio volume|edit,editor,Edit-Media,Show-Media|
|BlackDetect|Detect black periods in a video.|Get-Media|
|BlackFrame|Detects black frames.|Get-Media|
|BlendFrame|BlendFrame Extension|edit,editor,Edit-Media,Show-Media|
...
|Echo|Adds echoes to audio|edit,editor,Edit-Media,Show-Media|
|EdgeDetect|EdgeDetect Extension|Edit-Media,Show-Media|
|Emboss|Embosses video or images|Edit-Media|
|Exposure|Exposure Extension|edit,editor,Edit-Media,Show-Media|
...
|Hue|Hue Extension|edit,editor,Edit-Media,Show-Media|
|LagFun|Slowly update darker pixels.|edit,editor,Edit-Media,Show-Media|
...
|MedianPixel|Picks median pixels|edit,editor,Edit-Media,Show-Media|
...
|RandomizeFrame|RandomizeFrame extensions|edit,editor,Edit-Media,Show-Media|
