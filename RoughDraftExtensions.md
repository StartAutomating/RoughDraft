...
|AudioGain|Increases audio volume|Edit-Media,Show-Media,editor,edit|
|BlackDetect|Detect black periods in a video.|Get-Media|
|BlackFrame|Detects black frames.|Get-Media|
|BlendFrame|BlendFrame Extension|Edit-Media,Show-Media,editor,edit|
...
|Echo|Adds echoes to audio|Edit-Media,Show-Media,editor,edit|
|EdgeDetect|EdgeDetect Extension|Edit-Media,Show-Media|
|Emboss|Embosses video or images|Edit-Media|
|Exposure|Exposure Extension|Edit-Media,Show-Media,editor,edit|
...
|Hue|Hue Extension|Edit-Media,Show-Media,editor,edit|
|LagFun|Slowly update darker pixels.|Edit-Media,Show-Media,editor,edit|
...
|MedianPixel|Picks median pixels|Edit-Media,Show-Media,editor,edit|
...
|RandomizeFrame|RandomizeFrame extensions|Edit-Media,Show-Media,editor,edit|
