...
|AudioGain|Increases audio volume|edit,Show-Media,editor,Edit-Media|
|BlackDetect|Detect black periods in a video.|Get-Media|
|BlackFrame|Detects black frames.|Get-Media|
|BlendFrame|BlendFrame Extension|edit,Show-Media,editor,Edit-Media|
...
|Echo|Adds echoes to audio|edit,Show-Media,editor,Edit-Media|
|EdgeDetect|EdgeDetect Extension|Edit-Media,Show-Media|
|Emboss|Embosses video or images|Edit-Media|
|Exposure|Exposure Extension|edit,Show-Media,editor,Edit-Media|
...
|Hue|Hue Extension|edit,Show-Media,editor,Edit-Media|
|LagFun|Slowly update darker pixels.|edit,Show-Media,editor,Edit-Media|
...
|MedianPixel|Picks median pixels|edit,Show-Media,editor,Edit-Media|
...
|RandomizeFrame|RandomizeFrame extensions|edit,Show-Media,editor,Edit-Media|
