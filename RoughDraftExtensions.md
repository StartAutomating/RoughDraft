...
|AudioGain|Increases audio volume|editor,Show-Media,edit,Edit-Media|
|BlackDetect|Detect black periods in a video.|Get-Media|
|BlackFrame|Detects black frames.|Get-Media|
|BlendFrame|BlendFrame Extension|editor,Show-Media,edit,Edit-Media|
...
|Echo|Adds echoes to audio|editor,Show-Media,edit,Edit-Media|
|EdgeDetect|EdgeDetect Extension|Show-Media,Edit-Media|
|Emboss|Embosses video or images|Edit-Media|
|Exposure|Exposure Extension|editor,Show-Media,edit,Edit-Media|
...
|Hue|Hue Extension|editor,Show-Media,edit,Edit-Media|
|LagFun|Slowly update darker pixels.|editor,Show-Media,edit,Edit-Media|
...
|MedianPixel|Picks median pixels|editor,Show-Media,edit,Edit-Media|
...
|RandomizeFrame|RandomizeFrame extensions|editor,Show-Media,edit,Edit-Media|
